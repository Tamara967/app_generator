...
class ActivitiesSendToReviewPage():
    ...
    def scroll_down_to_window(self):    
        bar = self.driver.find_element_by_xpath('/html/body/div/div[1]/div[2]/div/div[3]/div/div')
        return self.driver.execute_script('arguments[0].scrollTop = arguments[0].scrollHeight', bar)
